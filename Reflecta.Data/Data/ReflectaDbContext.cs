...
using Reflecta.Data.Models;

namespace Reflecta.Data.Data;
...
public class ReflectaDbContext : DbContext
{
    ...
    private static void SeedTags(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Tag>().HasData(
            new Tag { Id = Guid.Parse("11111111-1111-1111-1111-111111111111"), Name = "Work", Color = "#4A90D9", IsSystem = true, UserId = null },
            new Tag { Id = Guid.Parse("22222222-2222-2222-2222-222222222222"), Name = "Personal", Color = "#7ED321", IsSystem = true, UserId = null },
            new Tag { Id = Guid.Parse("33333333-3333-3333-3333-333333333333"), Name = "Health", Color = "#F5A623", IsSystem = true, UserId = null },
            new Tag { Id = Guid.Parse("44444444-4444-4444-4444-444444444444"), Name = "Family", Color = "#D0021B", IsSystem = true, UserId = null },
            new Tag { Id = Guid.Parse("55555555-5555-5555-5555-555555555555"), Name = "Travel", Color = "#9013FE", IsSystem = true, UserId = null },
            new Tag { Id = Guid.Parse("66666666-6666-6666-6666-666666666666"), Name = "Goals", Color = "#50E3C2", IsSystem = true, UserId = null },
            new Tag { Id = Guid.Parse("77777777-7777-7777-7777-777777777777"), Name = "Learning", Color = "#BD10E0", IsSystem = true, UserId = null },
            new Tag { Id = Guid.Parse("88888888-8888-8888-8888-888888888888"), Name = "Relationships", Color = "#FF6B6B", IsSystem = true, UserId = null },
            new Tag { Id = Guid.Parse("99999999-9999-9999-9999-999999999999"), Name = "Mindfulness", Color = "#4ECDC4", IsSystem = true, UserId = null },
            new Tag { Id = Guid.Parse("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), Name = "Creativity", Color = "#FFE66D", IsSystem = true, UserId = null }
        );
    }
}
